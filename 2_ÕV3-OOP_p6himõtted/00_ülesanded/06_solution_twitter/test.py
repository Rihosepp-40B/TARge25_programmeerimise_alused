...
if __name__ == '__main__':
    tweet1 = Tweet("@realDonaldTrump", "Despite the negative press covfefe #Bigsmart", 1249, 50)
    tweet2 = Tweet("@elonmusk", "Technically, alcohol is a solution #Aigsmart", 366.4, 50)
    tweet3 = Tweet("@CIA", "We can neither confirm nor deny that this is our first tweet. #aeart", 2192, 50)
